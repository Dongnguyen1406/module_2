...
public class Car extends Vehicle {
    ...
    public String getInfoCarToFile(){
        return super.getLicensePlate() + "," + super.getManufacturerName() + "," + super.getYearOfManufacture() + "," + super.getOwner() + "," + this.vehicleType + "," + this.numberOfSeats;
    }
}